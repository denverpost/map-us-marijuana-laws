...
var color = d3.scale.linear()
    .range(["rgba(213,222,217)", "rgb(161,217,155)", "rgb(49,163,84)", "rgb(0,255,0)", "rgb(255,0,0)"]);
    ...
    d3.json('data/20161109.js', function(data) {
        ...
        .style('cursor', 'default')
            ...
            .style('fill', function(d) {
                ...
                var ballotResult = dataById[d.properties.name].ballotresult;
                if (value) {
                    //If value exists…
                    return color(value);
                } else {
            ...
            // .style('fill', function(d) {
            // 	var ballotResult = dataById[d.properties.name].ballotresult;
            // 	if (ballotResult == 'Pass') {
            // 		return 'rgb(143,17,0)'
            // 	} else if (ballotResult == 'Fail') {
            // 		return '#000'
            // 	}
            // })
